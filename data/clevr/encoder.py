"""
clevr: encoder.py | Author : Catherine Wong.

Utility function for loading the examples encoder for the CLEVR domain.
"""
...
class ClevrRNNExamplesEncoder(ModelLoader):
    """Loads the Clevr RNN encoder class. Note that this does not return an initialized model. It returns the class that can be instantiated from the experiment state, with other params set. Original source: dreamcoder/domains/clevr/clevrRecognition.py"""

    name = "clevr_rnn_examples_encoder"
